// components/DiscoverServersEmeraldForest.tsx
...
const DiscoverServersEmeraldForest: React.FC<DiscoverServersProps> = ({ onServerJoined }) => {
    ...
    return (
        <div className="flex flex-col flex-grow min-h-0 bg-gradient-to-br from-slate-900 via-green-900 to-emerald-950 p-8 overflow-y-auto relative">
            <div className="absolute inset-0 opacity-5"><div className="absolute inset-0" style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, #10b981 1px, transparent 0)', backgroundSize: '32px 32px' }}></div></div>
            ...
            <div className="relative z-10">
                <div className="mb-10">
                    <div className="flex items-center space-x-4 mb-3">
                        ...
                        <h1 className="text-4xl font-bold bg-gradient-to-r from-white via-emerald-100 to-green-100 bg-clip-text text-transparent drop-shadow-lg">{tr.discoverServers}</h1>
                    </div>
